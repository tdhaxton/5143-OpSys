...
| **job_jsons/** | Stores json files generated from generate_jobs.py. |
| ├── `process_file_INFO.txt` | Stores characteristics of each process file. |
| └── `process_file_XXXX.json` | json file of processes generated by job generater. |
